  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-10">
      {/* Micro-fade global na bordinha (padrão da plataforma): o conteúdo que
          ...
          seco. Cor do mundo (--color-warm-bg) → invisível sobre o fundo vazio,
          suaviza sobre os cards. z-[1] interno: acima do conteúdo (z-5), abaixo
          dos ícones (z-20). Overlay-irmão — não quebra o backdrop-filter. */}
      <div className="pointer-events-none absolute inset-x-0 top-0 z-[1] h-5 bg-gradient-to-b from-warm-bg to-transparent" />
      <TopBar />
      <CompanionPanels />
    </div>
  );
